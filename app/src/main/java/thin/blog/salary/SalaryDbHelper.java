...
import thin.blog.salary.SalaryContract.FeedEntry;
...
public class SalaryDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES = "CREATE TABLE " + FeedEntry.TABLE_NAME + " (" +
            ...
            FeedEntry.COLUMN_NAME_IN_TIME + TEXT_TYPE + COMMA_SEP +
            FeedEntry.COLUMN_NAME_OUT_TIME + TEXT_TYPE + COMMA_SEP +
            FeedEntry.COLUMN_NAME_PAY + " INTEGER" + ")";
